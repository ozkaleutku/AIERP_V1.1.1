...
const ProductExpandedContent = ({ product, isApproved, editingKey, editAmount, setEditAmount, startEditing, cancelEditing, saveEditing, fetchForecasts }) => {
    ...
    const historyYears = useMemo(() => {
        ...
        return [...new Set(detailData.sales_history.map(s => s.year))].sort((a, b) => a - b);
    }, [detailData]);
                                            ...
                                            {rowLocked ? (
                                                ...
                                                <div className="flex justify-end gap-2 text-gray-400 pr-1">
                                                    ...
                                                    <button onClick={async () => {
                                                        ...
                                                        try {
                                                            await api.post("/forecast/approve", { item_id: item.item_id, date: item.date });
...
const DemandForecast = () => {
    ...
    const filteredData = useMemo(() => {
        return forecasts.filter((item) => {
            ...
            return matchesId; // Date filtering makes less sense when grouping by product year, we'll keep it simple
        });
    }, [forecasts, filters]);
            ...
            <div className="flex-shrink-0 flex justify-between items-center">
                ...
                <div className="flex gap-2">
                    ...
                    >
                        ...
                        <span>{isApproved ? "Tümünü Onayla" : "Tümünü Onayla"}</span>
                    </button>
                    <button
